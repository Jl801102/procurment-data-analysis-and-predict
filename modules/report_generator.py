...
class ReportGenerator:
    ...
    def generate_word_report(strategies, analysis_summary, company_name="XX公司"):
        ...
        doc.add_paragraph(f"本报告基于系统采购数据分析，共识别出 {len(strategies)} 项降本机会，预计年化节省金额约 ¥{total_saving:,.0f}，占采购总额的 {saving_percent:.2f}%。")
        ...
        for i, strategy in enumerate(strategies, 1):
            ...
            rows_data = [
                ('预计节省金额', f"¥ {strategy.get('金额', 0):,.0f}"),
                ('节省比例', f"{strategy.get('比例', 0):.1%}"),
